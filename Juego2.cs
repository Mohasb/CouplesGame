...
namespace CouplesGame
{
    public partial class Juego2 : Form
    {
        ...
        private short reloj = 60;       //variable para establecer el valor del temporizador
        ...
        //Mètodo ejecutado al cargar el form que da bienvenida, pregunta si quiere sonidos y activa el contrareloj
        private void Juego_2_Load(object sender, EventArgs e)
        {
        ...
        private void CheckForWinner()
        {
            ...
            ContraReloj.Stop();
            MessageBox.Show("Has encontado todas las parejas de iconos pasas al nivel 3", "Felicidades");
            TercerNivel();
        }
        ...
        {
            Juego3 tres = new Juego3();
            Hide();
            tres.ShowDialog();
        }

        //Creo objeto clase Timer y lo inicializo ademas de poner el texto del contador en rojo y muestro el valor del relojz
        ...
        private void Juego2_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
